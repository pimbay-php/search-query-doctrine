...
Use [GitHub Security Advisories](https://github.com/pimbay-php/search-query-doctrine/security/advisories/new) for this repository, or email **security@pimbay.dev**.
...
Out of scope: vulnerabilities in `doctrine/dbal`, `doctrine/orm`, or PHP itself with no search-query-doctrine-specific exploitation path — report those upstream instead (see `docs/THIRD-PARTY-NOTICES.md` for what's bundled).
